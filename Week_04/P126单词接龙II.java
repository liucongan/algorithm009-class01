...
class P126WordLadderIi {
    ...
    class Solution {
        ...
        private List<List<String>> resolve1(String beginWord, String endWord, List<String> wordList) {
            List<List<String>> list = new ArrayList<>();
            Set<String> workSet = new HashSet<>(wordList);
            if (workSet.size() == 0 || !workSet.contains(endWord)){return list;}
            if (beginWord.equals(endWord)){
                List<String> list1 = Arrays.asList(beginWord);
                list.add(list1);
                return list;
            }
